...
- v0.2.0：<https://github.com/ActiveInAI/ArchIToken-VPN-Client/releases/tag/v0.2.0>
- Windows x64：<https://github.com/ActiveInAI/ArchIToken-VPN-Client/releases/download/v0.2.0/ArchIToken-VPN-Client-windows-x86_64.exe>
- Windows arm64：<https://github.com/ActiveInAI/ArchIToken-VPN-Client/releases/download/v0.2.0/ArchIToken-VPN-Client-windows-arm64.exe>
- Linux x64：<https://github.com/ActiveInAI/ArchIToken-VPN-Client/releases/download/v0.2.0/ArchIToken-VPN-Client-linux-x86_64>
- Linux arm64：<https://github.com/ActiveInAI/ArchIToken-VPN-Client/releases/download/v0.2.0/ArchIToken-VPN-Client-linux-arm64>
- macOS x64：<https://github.com/ActiveInAI/ArchIToken-VPN-Client/releases/download/v0.2.0/ArchIToken-VPN-Client-macos-x86_64>
- macOS arm64：<https://github.com/ActiveInAI/ArchIToken-VPN-Client/releases/download/v0.2.0/ArchIToken-VPN-Client-macos-arm64>
- Android：<https://github.com/ActiveInAI/ArchIToken-VPN-Client/releases/download/v0.2.0/ArchIToken-VPN-Client-android-universal-debug.apk>
- iOS simulator：<https://github.com/ActiveInAI/ArchIToken-VPN-Client/releases/download/v0.2.0/ArchIToken-VPN-Client-ios-simulator.zip>
- Python wheel：<https://github.com/ActiveInAI/ArchIToken-VPN-Client/releases/download/v0.2.0/architoken_vpn_client-0.2.0-py3-none-any.whl>

说明：Windows、Linux、macOS 已覆盖 x64 与 arm64。Android 当前发布 debug APK。iOS 当前发布 simulator 构建；真机安装、TestFlight、App Store 需要 Apple Developer 证书、描述文件和签名流水线。
