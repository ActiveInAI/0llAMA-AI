...
- Windows：<https://github.com/ActiveInAI/ArchIToken-VPN-Client/releases/download/v0.1.2/ArchIToken-VPN-Client-windows-x86_64.exe>
- Linux：<https://github.com/ActiveInAI/ArchIToken-VPN-Client/releases/download/v0.1.2/ArchIToken-VPN-Client-linux-x86_64>
- macOS：<https://github.com/ActiveInAI/ArchIToken-VPN-Client/releases/download/v0.1.2/ArchIToken-VPN-Client-macos-universal>
- Python wheel：<https://github.com/ActiveInAI/ArchIToken-VPN-Client/releases/download/v0.1.2/architoken_vpn_client-0.1.2-py3-none-any.whl>
