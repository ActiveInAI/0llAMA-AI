...
- v0.3.0：<https://github.com/ActiveInAI/ArchIToken-VPN-Client/releases/tag/v0.3.0>
- Windows x64：<https://github.com/ActiveInAI/ArchIToken-VPN-Client/releases/download/v0.3.0/ArchIToken-VPN-Client-windows-x86_64.exe>
- Windows arm64：<https://github.com/ActiveInAI/ArchIToken-VPN-Client/releases/download/v0.3.0/ArchIToken-VPN-Client-windows-arm64.exe>
- Linux x64：<https://github.com/ActiveInAI/ArchIToken-VPN-Client/releases/download/v0.3.0/ArchIToken-VPN-Client-linux-x86_64>
- Linux arm64：<https://github.com/ActiveInAI/ArchIToken-VPN-Client/releases/download/v0.3.0/ArchIToken-VPN-Client-linux-arm64>
- macOS x64：<https://github.com/ActiveInAI/ArchIToken-VPN-Client/releases/download/v0.3.0/ArchIToken-VPN-Client-macos-x86_64>
- macOS arm64：<https://github.com/ActiveInAI/ArchIToken-VPN-Client/releases/download/v0.3.0/ArchIToken-VPN-Client-macos-arm64>
- Android debug APK：<https://github.com/ActiveInAI/ArchIToken-VPN-Client/releases/download/v0.3.0/ArchIToken-VPN-Client-android-universal-debug.apk>
- Android unsigned release APK：<https://github.com/ActiveInAI/ArchIToken-VPN-Client/releases/download/v0.3.0/ArchIToken-VPN-Client-android-universal-release-unsigned.apk>
- Android unsigned release AAB：<https://github.com/ActiveInAI/ArchIToken-VPN-Client/releases/download/v0.3.0/ArchIToken-VPN-Client-android-universal-release-unsigned.aab>
- iOS simulator：<https://github.com/ActiveInAI/ArchIToken-VPN-Client/releases/download/v0.3.0/ArchIToken-VPN-Client-ios-simulator.zip>
- iOS Xcode source：<https://github.com/ActiveInAI/ArchIToken-VPN-Client/releases/download/v0.3.0/ArchIToken-VPN-Client-ios-source.zip>
- Python wheel：<https://github.com/ActiveInAI/ArchIToken-VPN-Client/releases/download/v0.3.0/architoken_vpn_client-0.3.0-py3-none-any.whl>

说明：Windows、Linux、macOS 已覆盖 x64 与 arm64。Android 已输出 debug APK、未签名 release APK 和未签名 AAB；上架或企业分发前需要接入 keystore 签名。iOS 当前发布 simulator 构建和 Xcode 源码包；真机安装、TestFlight、App Store 需要 Apple Developer 证书、描述文件和 App Store Connect 签名流水线。
