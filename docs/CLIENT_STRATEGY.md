...
- Current release: <https://github.com/ActiveInAI/ArchIToken-VPN-Client/releases/tag/v0.5.1>
...
- GitHub Actions 已升级到新主版本：`checkout@v6`、`setup-python@v6`、`setup-java@v5`、`upload-artifact@v7`、`download-artifact@v8`、`setup-android@v4`、`setup-gradle@v6`、`action-gh-release@v3`
- Windows x64 构建已固定到 `windows-2025-vs2026`，避免 `windows-latest` 迁移告警
