...
- Current release: <https://github.com/ActiveInAI/ArchIToken-VPN-Client/releases/tag/v0.4.0>
...
- Android `VpnService` 权限、启动/停止入口和运行时缺失保护
- iOS NetworkExtension 配置管理和 PacketTunnelProvider 模板

未完成的发布级事项：Windows 代码签名、macOS notarization、Android keystore 签名、iOS 真机/TestFlight/App Store 签名、移动端私有包内 Xray/tun2socks 或 PacketTunnel 运行器。
