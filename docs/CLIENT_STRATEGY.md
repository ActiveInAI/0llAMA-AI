...
- Current release: <https://github.com/ActiveInAI/ArchIToken-VPN-Client/releases/tag/v0.2.0>
...
未完成的发布级事项：Windows 代码签名、macOS notarization、Android release signing、iOS 真机/TestFlight 签名。
